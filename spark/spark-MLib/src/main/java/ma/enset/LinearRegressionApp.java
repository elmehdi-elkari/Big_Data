...
public class LinearRegressionApp {
    public static void main(String[] args) {
        ...
        SparkSession ss=SparkSession.builder().appName("tp sparkMlib ").master("local[*]").getOrCreate();

        Dataset<Row> dataset=ss.read().option("inferSchema",true).option("header",true).csv("spark-MLib/src/main/resources/advertising.csv");
