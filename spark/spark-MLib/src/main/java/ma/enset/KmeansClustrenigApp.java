...
public class KmeansClustrenigApp {
    public static void main(String[] args) {
        ...
        Dataset<Row> dataset = ss.read().option("inferSchema", true).option("header", true).csv("spark-MLib/src/main/resources/Mall_Customers.csv");
